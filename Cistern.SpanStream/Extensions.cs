...
namespace Cistern.SpanStream
{
    public static class Extensions
    {
        ...
        //- [ ] `int Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, int> selector);`
        //- [ ] `long Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, long> selector);`
        //- [ ] `decimal? Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, decimal?> selector);`
        //- [ ] `long? Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, long?> selector);`
        //- [ ] `int? Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, int?> selector);`
        //- [ ] `double Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, double> selector);`
        //- [ ] `float? Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, float?> selector);`
        //- [ ] `float Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, float> selector);`
        //- [ ] `double? Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, double?> selector);`
        //- [ ] `decimal Sum<TInitial>(this SpanHost<TInitial, TCurrent, TNode> source, Func<TInitial, decimal> selector);`
